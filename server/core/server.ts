...
export class Server {
  ...
  useHeaders() {
    ...
    this.app.options('*', <any>cors(corsOptions));
    ...
    if (size < 10) {
      ...
      for ( const city of cities) {
        ...
        wr.create( weather => {
          ...
          weather.main = city.main;
          weather.visibility = city.visibility;
          weather.wind = city.wind;
          weather.rain = city.rain;
          weather.snow = city.snow;
          weather.clouds = city.clouds;
          weather.dt = city.dt;
          weather.sys = city.sys;
      ...
      console.log('Database has 10 or more cities!');
    }
  }
